...
= WOOCOMMERCE ABANDONED CART REPORTS AND CONVERSION OPTIMIZATION PLUGIN =
...
Seeing where people click and what error messages annoyed them is now possible with HumCommerce Magic. See customers who can't complete their purchase with session replays and figure out exactly why that sale didn’t happen.
 ...
 [HumCommerce Magic](http://humcommerce.com/) has advanced intelligence to identify and show you Visitor Recordings for Frustrated Users on your website who:

* Abandoned their carts
* Saw error messages
* Clicked on elements that look like clicks but don’t go anywhere
...
Abandoned Cart report records the users who are trying to purchase but did not complete the purchase, along with other details like, lost cart value and location of the user.
...
The best part is that all the reports are right within your WordPress Dashboard. You get daily alerts of precise reports with insights that matter.

HumCommerce Magic comes with a simple dashboard for WooCommerce. You can see a summary of user experience, how much revenue was lost and the reason why you lost a potential customer? Session recording playback feature makes it possible to view these recordings and replay what the user experienced.

Once this plugin is installed, and activated, it monitors your website every day. Then it automatically generates the magic report. You get a daily summary email about the visitor experience on your WooCommerce store. You can also login to the dashboard to see experience details of each visitor for the day.

In a nutshell, if you are serious about improving conversion rate of your website HumCommerce Magic is a must have WooCommerce plugin which is POWERFUL and extremely USEFUL.
...
Activate the plugin, click on the “SET UP WITH ONE CLICK” button, and you are done. HumCommerce will start recording your visitors and generating the reports. You can view these reports in your WordPress dashboard.
...
We’d love to hear from you. You can raise support requests or offer feature suggestions from the HumCommerce Magic Dashboard.
